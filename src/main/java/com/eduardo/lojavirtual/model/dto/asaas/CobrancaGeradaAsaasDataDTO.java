...
public class CobrancaGeradaAsaasDataDTO {
    ...
    private CobrancaGeradaAsaasDiscountDTO discont = new CobrancaGeradaAsaasDiscountDTO();
    private CobrancaGeradaAsaasFineDTO fine = new CobrancaGeradaAsaasFineDTO();
    private CobrancaGeradaAsaasInterestDTO interest = new CobrancaGeradaAsaasInterestDTO();
    ...
    public CobrancaGeradaAsaasDiscountDTO getDiscont() {
        return discont;
    }

    public void setDiscont(CobrancaGeradaAsaasDiscountDTO discont) {
        this.discont = discont;
    }

    public CobrancaGeradaAsaasFineDTO getFine() {
        return fine;
    }

    public void setFine(CobrancaGeradaAsaasFineDTO fine) {
        this.fine = fine;
    }

    public CobrancaGeradaAsaasInterestDTO getInterest() {
        return interest;
    }

    public void setInterest(CobrancaGeradaAsaasInterestDTO interest) {
