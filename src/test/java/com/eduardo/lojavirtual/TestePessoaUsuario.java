...
public class TestePessoaUsuario extends TestCase {
    ...
    public void testCadPessoaJuridica() throws ExceptionMentoriaJava {
        ...
        pessoaJuridica.setInsEstadual("" + Calendar.getInstance().getTimeInMillis());
    ...
    public void testCadPessoaFisica() throws ExceptionMentoriaJava {
        ...
        PessoaJuridica pessoaJuridica =  pessoaRepository.existeCnpjCadastrado("1682262463263");

        PessoaFisica pessoaFisica = new PessoaFisica();
        pessoaFisica.setCpf("099.941.260-40");
        pessoaFisica.setNome("Telma");
        pessoaFisica.setEmail("telma@gmail.com");
